    ...
    <div className="relative">
      <ul className="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
        <li className="flex items-center space-x-3 text-left sm:space-x-4">
          <span className="font-semibold text-gray-900 hover:cursor-pointer" onClick={()=>router.back()}>Room</span>
        </li>
  ...
  <div className="px-4 pt-8">
    ...
    <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
      <div className="flex flex-col rounded-lg bg-white sm:flex-row">
        <Image className="m-2 h-24 w-28 rounded-md border object-cover object-center" src={hotel?.banner} width={28} height={24} alt="alt" />
